...
public class LablesController {
    ...
    @Resource
    private LablesService labService;

    @RequestMapping("/findalllabs")
    public List<Map<String,Object>> findAll() {
        List<Map<String,Object>> list=labService.findAll();
        return list;
    }
     ...
     * @return
     */
    @RequestMapping("/findbylabid")
    public Map<String,Object> findByLabid(@RequestParam int labid){
        Map<String,Object> map=labService.findLabName(labid);
        return map;
    }
    ...
    public String save(@RequestParam Map<String,String> map){
        String msg="增加失败";
        boolean flag=labService.doSave(map);
        if(flag){
            msg="增加成功";
        }
        return msg;
    ...
    public String deleteLab(@RequestParam Map<String,String> map){
        String msg="删除失败";
        boolean flag=labService.doDeleteLab(map);
        if(flag){
            msg="删除成功";
        }
        return msg;
    ...
    @RequestMapping("/editlable")
    public String update(@RequestParam Map<String,String> map){
        String msg="修改失败";
        boolean flag=labService.doUpdate(map);
        if(flag){
            msg="修改成功";
        }
        return msg;
